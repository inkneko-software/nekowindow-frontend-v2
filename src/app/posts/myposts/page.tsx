          ...
          <TableBody>
            <TableRow>
              <TableCell sx={{ paddingLeft: '32px', display: 'flex' }}>
                {/* 视频封面 */}
                <Box sx={{ position: 'relative', width: '127px', height: '72px', borderRadius: '8%', overflow: 'hidden', border: '1px #e3e3e3 solid' }}>
                  <Box component='img' sx={{ width: '100%', height: '100%', positoin: 'absolute' }} src='/images/assert/login_bg.jpg' />
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', marginLeft: '16px', justifyContent: 'space-evenly' }}>
                  <Typography variant='body2'>视频标题</Typography>
                  <Typography variant='body2'>点击添加说明</Typography>
                </Box>
              </TableCell>
              <TableCell >公开范围</TableCell>
              <TableCell>日期</TableCell>
