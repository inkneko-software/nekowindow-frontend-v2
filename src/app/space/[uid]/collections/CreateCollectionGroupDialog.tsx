...
export interface CreateCollectionGroupDialogProps {
    open: boolean;
    onClose: () => void;
...
export default function CreateCollectionGroupDialog({ open, onClose, onConfirm }: CreateCollectionGroupDialogProps) {
    ...
    return (
        <Dialog open={open} sx={{ ".MuiPaper-root": { width: '360px' } }}>
            <Box sx={{ display: 'flex', padding: 1 }}>
                <Typography variant='h5' noWrap sx={{ margin: "auto auto auto 16px" }}>创建收藏夹</Typography>
            ...
            <DialogContent>
                ...
                <Box sx={{ display: 'flex', marginTop: '16px' }}>
                    ...
                    <Button onClick={handleConfirm} sx={{ flexGrow: '1', marginLeft: '8px' }} variant="contained">创建</Button>
                </Box>
            </DialogContent>
